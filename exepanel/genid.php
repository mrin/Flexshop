...
if(!isset($_SESSION["secimg"])) $_SESSION["secimg"] = $nm;
	else $_SESSION["secimg"]=$nm;
...
for ($i=1; $i<=6; $i++)
 {
	imageTtfText($img, 20, $angle, $x, $ctr+10, rnd_color($img), $homedir."/lib/font/".rnd_font(), "$r");
	$r=$rn[$i];
	$x=$x+15;
	$angle=rand(-30,40);
 }
