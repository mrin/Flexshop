...
<form action="{URLSITE}/exepanel/category.php?type=add&method=add&cat={CATEGORYID}" method=POST>
<table align='center' border="1"  class='dash' cellpadding='5' cellspacing='0'>
	...
	<tr>
		...
		<td align=center class="contlight"><input type="text" name="nameru" size=30 class="inputtext"></td>
		<td align=center class="contlight"><input type="text" name="nameen" size=30 class="inputtext"></td>
	</tr>
</table>
